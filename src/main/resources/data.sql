...
INSERT INTO API_USER(EMAIL, FIRSTNAME, LASTNAME, LOGIN, PASSWORD, ROLE)
VALUES ( 'jas.fasola@test.pl', 'Jasiu', 'Fasola', 'JasFas', 'kuna', 'BASIC_USER');

INSERT INTO BASIC_USER(ID) VALUES ( 1 );
INSERT INTO BASIC_USER(ID) VALUES ( 2 );

INSERT INTO VISITOR(EMAIL, FIRSTNAME, LASTNAME)
VALUES('vistor1@gmal.com', 'Heniu', 'Krzak');

INSERT INTO VISITOR(EMAIL, FIRSTNAME, LASTNAME)
VALUES('vistor2@gmal.com', 'Hania', 'Drzewo');
...
INSERT INTO EXTERNAL_EVENTS_VISITORS(EXTERNAL_EVENT_ID, VISITOR_ID)
VALUES ( 4, 1 ),
       ( 4, 2 );
